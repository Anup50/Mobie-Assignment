    ...
    return Column(
      ...
      children: [
        ...
        const Padding(
          ...
          child: Text('Illustrations',style: TextStyle(color: Colors.white,fontWeight: FontWeight.w600,fontSize: 20),),
        ),
        SizedBox(
          height: 120,
                ...
                child: Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        Obx(() => controller.selectedImage.value==index ? const Icon(Icons.keyboard_arrow_up,color: Colors.black) : const SizedBox(),)
                      ],
                    )),
              );
            },),
